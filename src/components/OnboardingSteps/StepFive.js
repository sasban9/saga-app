...
const StepFive = () => {
  ...
  return (
    <>
      ...
      <Col xs={24} md={18} lg={16} xl={12}>
        ...
        ✔️ SFTP setup for photographer (if photographer is printing): <Tag color='green'>DONE</Tag>   <br/>
        ✔️ Magic upload square photos looking right (not cropped)? <Tag color='green'>DONE</Tag>   <br/>
        ❌ Group and Group Fun photos coming correctly for respective classes? <Tag color='green'>YES</Tag>  <br/>
        ❌ Orientation of cartonnages for horizontal photos <Tag color='green'>DONE</Tag>   <br/>
        ✔️ Album cover photo is marked correctly for the multi-poses? <Tag color='green'>DONE</Tag> <br/>( Example: In Green-screen schools if the cover photos are not correct, the cartonnages will have errors )  <br/>
        <img
          alt=""
          style={{ margin: 16 }}
          ...
          align="right"
        />
        ✔️ Products with “Photo détourée” photos in print structure should have below version in HTML to PDF ( Green-Screen FIX: 0.12.1.4, possible white-line issue ) <hr/>
        ✔️ Accessories should be marked as Accessories <br/>
        ✔️ Production separator files should not get generated for accessories.  <br/>
        ...
        <img
          ...
          style={{ margin: 16 }}
          height={300}
          src="https://ouch-cdn2.icons8.com/gwzh1o5GF0Z1mGqYjERbpfuWVJsjxB71lUQJsPwSR64/rs:fit:256:472/czM6Ly9pY29uczgu/b3VjaC1wcm9kLmFz/c2V0cy9wbmcvODk3/LzJhOTI2MDk0LTQx/YWUtNDg2ZS1iYzli/LWU5YzFjNWUzN2Ix/Zi5wbmc.png"
          align="left"
        />
 <br/>
 <h3>Calculated <Tag color='red-inverse'>1/9</Tag></h3>
 ...
 ❌ For products with 600dpi where web kit rotation used in CSS where variable is set to pick kid photo or class photo.  <br/>
 ❌ Items where radius:0.5mm radius used in CSS in print structures 
        </div>
      </Col>
    </>
  );
